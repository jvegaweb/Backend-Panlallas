...
class ClienteController extends Controller
{
    public function index()
    {
        ...
        $clientes = Cliente::with(['screens'])->get();
    ...
    public function create()
    {
        ...
        $screens = Pantalla::pluck('name_screen', 'id');

        return view('admin.clientes.create', compact('screens'));
    }

    public function store(StoreClienteRequest $request)
    {
        $cliente = Cliente::create($request->all());
        $cliente->screens()->sync($request->input('screens', []));
    ...
    public function edit(Cliente $cliente)
    {
        ...
        $cliente->load('screens');

        return view('admin.clientes.edit', compact('screens', 'cliente'));
    }
