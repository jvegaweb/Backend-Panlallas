...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.pantalla.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pantallas.update", [$pantalla->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name_screen">{{ trans('cruds.pantalla.fields.name_screen') }}</label>
                <input class="form-control {{ $errors->has('name_screen') ? 'is-invalid' : '' }}" type="text" name="name_screen" id="name_screen" value="{{ old('name_screen', $pantalla->name_screen) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('features') ? 'is-invalid' : '' }}" name="features" id="features">{!! old('features', $pantalla->features) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url_tour') ? 'is-invalid' : '' }}" type="text" name="url_tour" id="url_tour" value="{{ old('url_tour', $pantalla->url_tour) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('brochure') ? 'is-invalid' : '' }}" type="text" name="brochure" id="brochure" value="{{ old('brochure', $pantalla->brochure) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('plants') ? 'is-invalid' : '' }}" type="text" name="plants" id="plants" value="{{ old('plants', $pantalla->plants) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link_video') ? 'is-invalid' : '' }}" type="text" name="link_video" id="link_video" value="{{ old('link_video', $pantalla->link_video) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_gallery_1s') ? 'is-invalid' : '' }}" name="id_gallery_1s[]" id="id_gallery_1s" multiple>
                    @foreach($id_gallery_1s as $id => $id_gallery_1)
                        <option value="{{ $id }}" {{ (in_array($id, old('id_gallery_1s', [])) || $pantalla->id_gallery_1s->contains($id)) ? 'selected' : '' }}>{{ $id_gallery_1 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_gallery_2s') ? 'is-invalid' : '' }}" name="id_gallery_2s[]" id="id_gallery_2s" multiple>
                    @foreach($id_gallery_2s as $id => $id_gallery_2)
                        <option value="{{ $id }}" {{ (in_array($id, old('id_gallery_2s', [])) || $pantalla->id_gallery_2s->contains($id)) ? 'selected' : '' }}>{{ $id_gallery_2 }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mapa') ? 'is-invalid' : '' }}" type="text" name="mapa" id="mapa" value="{{ old('mapa', $pantalla->mapa) }}">
                @if($errors->has('mapa'))
                    <div class="invalid-feedback">
                        {{ $errors->first('mapa') }}
                    </div>
